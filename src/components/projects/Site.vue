<template>
  <ion-card>
    ...
    <ion-card-content class="description">
      Это сайт с открытым исходным кодом, созданный для представления моих проектов и представляющий моё портфолио.
      <br>
      <br>
      <h1>Функционал:</h1>
      <ul>
        <li>Страница с моим описанием</li>
        <li>Страница со все мои проекты и описанием каждого</li>
